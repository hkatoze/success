...
class StartTemperamentTestView extends StatefulWidget {
  const StartTemperamentTestView({super.key, required this.user});
  final User user;

  @override
  State<StartTemperamentTestView> createState() =>
      _StartTemperamentTestViewState();
}

class _StartTemperamentTestViewState extends State<StartTemperamentTestView> {
  @override
  void initState() {
    super.initState();
  }
                    ...
                    onTap: () {
                      Navigator.push(
                          ...
                          PageTransition(
                              ...
                              curve: Curves.ease,
                              childCurrent: StartTemperamentTestView(
                                user: widget.user,
                              ),
                              child: Mainview(
                                user: widget.user,
                                ...
                                child: SizedBox(
                                  ...
                                  child: DefaultTextStyle(
                                    ...
                                    child: AnimatedTextKit(
                                      ...
                                      animatedTexts: [
                                        TyperAnimatedText(
                                            "Une suite d'adjectifs qualificatifs te seront proposer afin que tu choisisses tes forces et tes faiblesses.Si tu es perdu n'hésite pas  à te faire aider par un de tes proches qui te connais le mieux",
